...
public class ProxyVpnService extends VpnService {
    ...
    private static final String CHANNEL_ID = "PrismSpaceVPN";
    ...
    private void createNotificationChannel() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            NotificationChannel channel = new NotificationChannel(
                CHANNEL_ID,
                "PrismSpace VPN Service",
                NotificationManager.IMPORTANCE_LOW
            );
            channel.setDescription("VPN service for PrismSpace network access");
    ...
    private Notification createNotification() {
        ...
        return builder
            .setContentTitle("PrismSpace VPN Active")
    ...
    protected void establishVpn() {
        ...
        try {
            ...
            builder.setSession("PrismSpace VPN");
            ...
            builder.setSession("PrismSpace Internet Access");
