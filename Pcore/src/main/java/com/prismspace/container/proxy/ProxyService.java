...
public class ProxyService extends Service {
    ...
    private void showNotification() {
        NotificationCompat.Builder builder = new NotificationCompat.Builder(getApplicationContext(), getPackageName() + ".prismspace_proxy")
                .setPriority(NotificationCompat.PRIORITY_MAX);
        if (PuildCompat.isOreo()) {
            startForeground(PrismSpaceCore.getHostPkg().hashCode(), builder.build());
        }
    }
