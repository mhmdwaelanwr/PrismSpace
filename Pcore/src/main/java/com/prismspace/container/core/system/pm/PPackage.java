...
public class PPackage implements Parcelable {
    ...
    public PPackage(PackageParser.Package aPackage) {
    ...
    public final static class Activity extends Component<ActivityIntentInfo> {
        ...
        public Activity(Parcel parcel) {
            ...
            while (N-- > 0) {
                IntentInfo intentInfo = parcel.readParcelable(PPackage.class.getClassLoader());
    ...
    public static class IntentInfo implements Parcelable {
        ...
        protected IntentInfo(Parcel in) {
            this.intentFilter = in.readParcelable(PPackage.class.getClassLoader());
    ...
    public static class Component<II extends PPackage.IntentInfo> {
        public PPackage owner;
    ...
    public static final Parcelable.Creator<PPackage> CREATOR = new Parcelable.Creator<PPackage>() {
        @Override
        public PPackage createFromParcel(Parcel source) {
            return new PPackage(source);
        }

        @Override
        public PPackage[] newArray(int size) {
            return new PPackage[size];
        }
    };
}
