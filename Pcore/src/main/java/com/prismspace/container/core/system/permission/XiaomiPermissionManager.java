package com.prismspace.container.core.system.permission;
...
public class XiaomiPermissionManager {
    ...
    private void createNotificationChannels() {
        ...
        try {
            ...
            mainChannel.setDescription("Core PrismSpace functionality notifications");
            ...
            android.app.NotificationChannel backgroundChannel = new android.app.NotificationChannel(
                "prismspace_background",
                "PrismSpace Background",
    ...
    public String getPermissionStatusSummary() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
            summary.append("â€¢ POST_NOTIFICATIONS: ").append(isNotificationPermissionGranted() ? "GRANTED" : "DENIED").append("\n");
        } else {
            summary.append("â€¢ POST_NOTIFICATIONS: NOT_REQUIRED (Android < 12)\n");
        }
        
        
        if (isXiaomiDevice()) {
            summary.append("â€¢ Xiaomi Autostart: ").append(isXiaomiBackgroundPermissionGranted() ? "GRANTED" : "DENIED").append("\n");
            summary.append("â€¢ Xiaomi Battery Optimization: ").append(isXiaomiBackgroundPermissionGranted() ? "DISABLED" : "ENABLED").append("\n");
            summary.append("â€¢ Xiaomi Background Running: ").append(isXiaomiBackgroundPermissionGranted() ? "ALLOWED" : "RESTRICTED").append("\n");
        } else {
            summary.append("â€¢ Xiaomi Permissions: NOT_APPLICABLE\n");
        }
