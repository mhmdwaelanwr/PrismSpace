...
import com.prismspace.container.core.system.pm.PackageMonitor;
import com.prismspace.container.core.system.user.PUserHandle;
import com.prismspace.container.utils.ArrayUtils;
...
import com.prismspace.container.utils.compat.AccountManagerCompat;


@SuppressLint("InlinedApi")
public class PAccountManagerService extends IBAccountManagerService.Stub implements ISystemService , PackageMonitor {
    private static final String TAG = "AccountManagerService";

    private static PAccountManagerService sService = new PAccountManagerService();
    ...
    private final PPackageManagerService mPms;
    private final Map<Integer, PUserAccounts> mUserAccountsMap = new HashMap<>();
    ...
    public static PAccountManagerService get() {
        return sService;
    }

    public PAccountManagerService() {
        mContext = PrismSpaceCore.getContext();
        mPms = PPackageManagerService.get();
    }
    ...
    private void loadAccounts() {
        ...
        try {
            ...
            HashMap<Integer, PUserAccounts> accountsMap = parcel.readHashMap(PUserAccounts.class.getClassLoader());
            if (accountsMap == null)
                return;
    ...
    public String getPassword(Account account, int userId) throws RemoteException {
        ...
        PUserAccounts accounts = getUserAccounts(userId);
    ...
    public void copyAccountToUser(IAccountManagerResponse response, Account account, int userFrom, int userTo) throws RemoteException {
        final PUserAccounts fromAccounts = getUserAccounts(userFrom);
        final PUserAccounts toAccounts = getUserAccounts(userTo);
    ...
    public void invalidateAuthToken(String accountType, String authToken, int userId) throws RemoteException {
        ...
        synchronized (accounts.lock) {
            ...
            for (PAccount account : accounts.accounts) {
                if (account.account.type.equals(accountType)) {
    ...
    public void setPassword(Account account, String password, int userId) throws RemoteException {
        ...
        if (accounts == null)
            return;
        synchronized (accounts.lock) {
            PAccount bAccount = accounts.getAccount(account);
    ...
    public void getAuthToken(IAccountManagerResponse response, Account account, String authTokenType, boolean notifyOnAuthFailure, boolean expectActivityLaunch, Bundle loginOptions, int userId) throws RemoteException {
        ...
        final PUserAccounts accounts = getUserAccounts(userId);
    ...
    protected void saveCachedToken(PUserAccounts accounts,
                                   Account account,
                                   String callerPkg,
                                   String tokenType,
                                   String token,
    ...
    protected void saveAuthTokenToDatabase(PUserAccounts accounts, Account account, String
    ...
    protected String readAuthTokenInternal(PUserAccounts accounts, Account account,
    ...
    private void completeCloningAccount(IAccountManagerResponse response,
                                        final Bundle accountCredentials, final Account account, final PUserAccounts targetUser,
    ...
    private boolean addAccountInternal(PUserAccounts accounts, Account account, String password,
                                       Bundle extras, Map<String, Integer> packageToVisibility) {
        if (accounts == null) {
            accounts = new PUserAccounts();
        }
        synchronized (accounts.lock) {
            PAccount bAccount = accounts.getAccount(account);
            if (bAccount != null) {
    ...
    private boolean setAccountVisibility(Account account, String packageName, int newVisibility, PUserAccounts accounts) {
        synchronized (accounts.lock) {
            PAccount bAccount = accounts.getAccount(account);
            if (bAccount == null)
                return false;
    ...
    protected Account[] getAccountsFromCache(PUserAccounts userAccounts, String accountType, String callingPackage, boolean includeManagedNotVisible) {
        if (accountType != null) {
            Account[] accounts;
            synchronized (userAccounts.lock) {
            ...
            synchronized (mUserAccountsMap) {
                for (PUserAccounts bUserAccounts : mUserAccountsMap.values()) {
    ...
    @NonNull
    private Account[] filterAccounts(PUserAccounts accounts, Account[] unfiltered, String callingPackage, boolean includeManagedNotVisible) {
    ...
    private String readUserDataInternal(PUserAccounts accounts, Account account, String key) {
        if (accounts == null)
            return null;
        synchronized (accounts.lock) {
    ...
    public String readPasswordInternal(PUserAccounts accounts, Account account) {
        if (accounts == null)
            return null;
        synchronized (accounts.lock) {
            PAccount bAccount = accounts.getAccount(account);
    ...
    public PUserAccounts getUserAccounts(int userId) {
        synchronized (mUserAccountsMap) {
            PUserAccounts bUserAccounts = mUserAccountsMap.get(userId);
            if (bUserAccounts == null) {
                bUserAccounts = new PUserAccounts();
    ...
    private boolean isAccountPresentForCaller(String accountName, String accountType, int userId) {
        PUserAccounts userAccounts = getUserAccounts(userId);
        if (userAccounts != null) {
            PAccount account = userAccounts.getAccount(new Account(accountName, accountType));
            return account != null;
        }
        return false;
    }

    private boolean removeAccountInternal(PUserAccounts accounts, Account account) {
        synchronized (accounts.lock) {
    ...
    private class RemoveAccountSession extends Session {
        ...
        public RemoveAccountSession(PUserAccounts accounts, IAccountManagerResponse response,
    ...
    public void loadAuthenticatorCache(String packageName) {
        ...
        generateServicesMap(
                mPms.queryIntentServices(intent, PackageManager.GET_META_DATA, PUserHandle.USER_ALL),
    ...
    private abstract class Session extends IAccountAuthenticatorResponse.Stub
        ...
        protected final PUserAccounts mAccounts;

        public Session(PUserAccounts accounts, IAccountManagerResponse response, String accountType,
    ...
    private boolean updateLastAuthenticatedTime(PUserAccounts userAccounts, Account account) {
    ...
    private String getCallingPackageName() {
        ...
        ProcessRecord processByPid = PProcessManagerService.get().findProcessByPid(callingPid);
