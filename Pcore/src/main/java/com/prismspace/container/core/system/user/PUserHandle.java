...
public final class PUserHandle implements Parcelable {
    ...
    public static final PUserHandle ALL = new PUserHandle(USER_ALL);

    
    public static final int USER_CURRENT = -2;

    
    public static final PUserHandle CURRENT = new PUserHandle(USER_CURRENT);
    ...
    public static final PUserHandle CURRENT_OR_SELF = new PUserHandle(USER_CURRENT_OR_SELF);
    ...
    @Deprecated
    public static final PUserHandle OWNER = new PUserHandle(USER_OWNER);
    ...
    public static final PUserHandle SYSTEM = new PUserHandle(USER_SYSTEM);
    ...
    public static PUserHandle getUserHandleForUid(int uid) {
    ...
    public static int getUserId(int uid) {
        if (MU_ENABLED) {
            ...
            return PUserHandle.USER_SYSTEM;
        }
    }
    ...
    public static PUserHandle of(int userId) {
        return userId == USER_SYSTEM ? SYSTEM : new PUserHandle(userId);
    }
    ...
    public static int parseUserArg(String arg) {
        int userId;
        if ("all".equals(arg)) {
            userId = PUserHandle.USER_ALL;
        } else if ("current".equals(arg) || "cur".equals(arg)) {
            userId = PUserHandle.USER_CURRENT;
        } else {
            try {
    ...
    public boolean equals(Object obj) {
        try {
            if (obj != null) {
                PUserHandle other = (PUserHandle) obj;
    ...
    public static void writeToParcel(PUserHandle h, Parcel out) {
        if (h != null) {
    ...
    public static PUserHandle readFromParcel(Parcel in) {
        int h = in.readInt();
        return h != USER_NULL ? new PUserHandle(h) : null;
    }

    public static final Parcelable.Creator<PUserHandle> CREATOR
            = new Creator<PUserHandle>() {
        public PUserHandle createFromParcel(Parcel in) {
            return new PUserHandle(in);
        }

        public PUserHandle[] newArray(int size) {
            return new PUserHandle[size];
        }
    };

    
    public PUserHandle(Parcel in) {
        mHandle = in.readInt();
    }
}
