...
public class PResourcesManager implements IInjectHook {
    private static final String TAG = "PResourcesManager";
    ...
    private static Object getPackageManager() {
        try {
            Class<?> blackBoxCoreClass = Class.forName("com.prismspace.container.PrismSpaceCore");
