    ...
    public static class AttributionSourceConstructor extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            try {
                ...
                int uid = PrismSpaceCore.getHostUid();
                String packageName = PrismSpaceCore.getHostPkg();
                ...
                return createSafeAttributionSource(PrismSpaceCore.getHostUid(), PrismSpaceCore.getHostPkg());
            }
        }
    ...
    public static class FromParcel extends MethodHook {
        ...
        private void fixAttributionSourceUid(Object attributionSource) {
            try {
                ...
                Slog.d(TAG, "Fixed AttributionSource UID to: " + PrismSpaceCore.getHostUid());
            } catch (Exception e) {
