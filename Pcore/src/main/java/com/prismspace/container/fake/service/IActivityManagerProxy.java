...
import com.prismspace.container.entity.am.RunningAppProcessInfo;
import com.prismspace.container.entity.am.RunningServiceInfo;
import com.prismspace.container.fake.delegate.ContentProviderDelegate;
import com.prismspace.container.fake.delegate.InnerReceiverDelegate;
import com.prismspace.container.fake.delegate.ServiceConnectionDelegate;
...
import com.prismspace.container.proxy.record.ProxyPendingRecord;
...
public class IActivityManagerProxy extends ClassInvocationStub {
    ...
    public static class GetContentProvider extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            if (auth instanceof String) {
                ...
                if (PuildCompat.isQ()) {
                    args[1] = PrismSpaceCore.getHostPkg();
                }
                ...
                if (auth.equals("settings")
                    ...
                    ProviderInfo providerInfo = PrismSpaceCore.getBPackageManager()
                            .resolveContentProvider(
                                    (String) auth, GET_META_DATA, PActivityThread.getUserId());
                    ...
                    if (PActivityThread.getAppPid() != -1) {
                        AppConfig appConfig = PrismSpaceCore.getBActivityManager()
                                .initProcess(
                                        providerInfo.packageName,
                                        providerInfo.processName,
                                        PActivityThread.getUserId());
                        if (appConfig.bpid != PActivityThread.getAppPid()) {
                            providerBinder = PrismSpaceCore.getBActivityManager()
                                    .acquireContentProviderClient(providerInfo);
                        }
                        args[authIndex] = ProxyManifest.getProxyAuthorities(appConfig.bpid);
                        args[getUserIndex()] = PrismSpaceCore.getHostUserId();
                    }
    ...
    public static class StartService extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            ResolveInfo resolveInfo = PrismSpaceCore.getBPackageManager().resolveService(intent, 0, resolvedType, PActivityThread.getUserId());
            if (resolveInfo == null) {
                return method.invoke(who, args);
            }
            ...
            return PrismSpaceCore.getBActivityManager().startService(intent, resolvedType, requireForeground, PActivityThread.getUserId());
        }
    ...
    public static class StopService extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            try {
                ...
                return PrismSpaceCore.getBActivityManager().stopService(intent, resolvedType, PActivityThread.getUserId());
            } catch (SecurityException e) {
    ...
    public static class StopServiceToken extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            try {
                ...
                PrismSpaceCore.getBActivityManager().stopServiceToken(componentName, token, PActivityThread.getUserId());
                return true;
            } catch (SecurityException e) {
    ...
    public static Object BindServiceCommon(Object who, Method method, Object[] args,int callingPackageIndex) throws Throwable {
        try {
            ...
            ResolveInfo resolveInfo = PrismSpaceCore.getBPackageManager().resolveService(intent, 0, resolvedType, userId);
            if (resolveInfo != null || AppSystemEnv.isOpenPackage(intent.getComponent())) {
                Intent proxyIntent = PrismSpaceCore.getBActivityManager().bindService(intent,
                ...
                if (proxyIntent != null && proxyIntent.getComponent() != null && 
                    proxyIntent.getComponent().getPackageName().equals(PrismSpaceCore.getHostPkg())){
                ...
                args[callingPackageIndex] = PrismSpaceCore.getHostPkg();
    ...
    public static class BindService extends MethodHook {
        ...
        protected boolean isEnable() {
            return PrismSpaceCore.get().isBlackProcess() || PrismSpaceCore.get().isServerProcess();
        }
    }
    ...
    public static class UnbindService extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            PrismSpaceCore.getBActivityManager().unbindService(iServiceConnection.asBinder(), PActivityThread.getUserId());
    ...
    public static class GetIntentSender extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            for (int i = 0; i < intents.length; i++) {
                ...
                switch (type) {
                    case ActivityManagerCompat.INTENT_SENDER_ACTIVITY:
                        ...
                        shadow.setComponent(new ComponentName(PrismSpaceCore.getHostPkg(), ProxyManifest.getProxyPendingActivity(PActivityThread.getAppPid())));
            ...
            if (invoke != null) {
                String[] packagesForUid = PPackageManager.get().getPackagesForUid(PActivityThread.getCallingBUid());
                if (packagesForUid.length < 1) {
                    packagesForUid = new String[]{PrismSpaceCore.getHostPkg()};
                }
                PrismSpaceCore.getBActivityManager().getIntentSender(invoke.asBinder(), packagesForUid[0], PActivityThread.getCallingBUid());
            }
            return invoke;
        }
    ...
    public static class getPackageForIntentSender extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            return PrismSpaceCore.getBActivityManager().getPackageForIntentSender(invoke.asBinder());
        }
    }
    ...
    public static class getUidForIntentSender extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            IInterface invoke = (IInterface) args[0];
            return PrismSpaceCore.getBActivityManager().getUidForIntentSender(invoke.asBinder());
        }
    }
    ...
    public static class BroadcastIntent extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            Intent proxyIntent = PrismSpaceCore.getBActivityManager().sendBroadcast(intent, resolvedType, PActivityThread.getUserId());
            if (proxyIntent != null) {
    ...
    public static class PeekService extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            IBinder peek = PrismSpaceCore.getBActivityManager().peekService(intent, resolvedType, PActivityThread.getUserId());
            return peek;
        }
    }
    ...
    public static class getCurrentUser extends MethodHook {
        @Override
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            Object prismSpace = BRUserInfo.get()._new(PActivityThread.getUserId(), "PrismSpace", BRUserInfo.get().FLAG_PRIMARY());
            return prismSpace;
        }
    }
