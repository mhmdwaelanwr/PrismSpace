...
public class ISensitiveContentProtectionManagerProxy extends PinderInvocationStub {
            ...
            if (args != null && args.length > 0) {
                ...
                for (int i = 0; i < args.length; i++) {
                    if (args[i] instanceof String) {
                        ...
                        if (pkg != null && !pkg.equals(PrismSpaceCore.getHostPkg())) {
                            Slog.d(TAG, "Fixing package name in setSensitiveContentProtection: " + pkg + " -> " + PrismSpaceCore.getHostPkg());
