...
import com.prismspace.container.utils.AttributionSourceUtils;


public class ContentProviderStub extends ClassInvocationStub implements PContentProvider {
    ...
    private void fixAttributionSourceUid(Object attributionSource) {
        try {
            ...
            try {
                ...
                uidField.set(attributionSource, PrismSpaceCore.getHostUid());
                ...
                try {
                    ...
                    try {
                        ...
                        setUidMethod.invoke(attributionSource, PrismSpaceCore.getHostUid());
