        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            try {
                if (args != null && args.length > 0 && args[0] instanceof Context) {
                    ...
                    context = PrismSpaceCore.getContext();
                }
        ...
        private void configureWebView(WebView webView) {
            try {
                ...
                if (settings != null) {
                    ...
                    if (userAgent != null && !userAgent.contains("PrismSpace")) {
                        settings.setUserAgentString(userAgent + " PrismSpace");
                    }
    ...
    public static class GetDataDirectory extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            try {
                ...
                return "/data/data/" + PrismSpaceCore.getHostPkg() + "/webview_fallback";
            }
        }
    }
