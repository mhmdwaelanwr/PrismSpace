...
public class IAppOpsManagerProxy extends PinderInvocationStub {
    ...
    protected void inject(Object baseInvocation, Object proxyInvocation) {
        if (BRAppOpsManager.get(null)._check_mService() != null) {
            AppOpsManager appOpsManager = (AppOpsManager) PrismSpaceCore.getContext().getSystemService(Context.APP_OPS_SERVICE);
            try {
