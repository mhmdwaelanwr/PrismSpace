...
public class SystemProviderStub extends ClassInvocationStub implements PContentProvider {
            ...
            if (args != null) {
                ...
                for (int i = 0; i < args.length; i++) {
                    ...
                    if (arg != null && attributionSourceClass != null && 
                        ...
                        ContextCompat.fixAttributionSourceState(arg, PrismSpaceCore.getHostUid());
                    }
                }
            }
            return method.invoke(mBase, args);
