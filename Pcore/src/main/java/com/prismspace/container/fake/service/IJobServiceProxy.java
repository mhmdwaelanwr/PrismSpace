...
import com.prismspace.container.utils.UIDSpoofingHelper;


public class IJobServiceProxy extends PinderInvocationStub {
    ...
    public static class Schedule extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            try {
                ...
                try {
                    JobInfo proxyJobInfo = PrismSpaceCore.getBJobManager().schedule(jobInfo);
                    ...
                    Slog.w(TAG, "Schedule: PrismSpace job manager failed, trying system fallback", e);
                }
    ...
    public static class Cancel extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            try {
                ...
                args[0] = PrismSpaceCore.getBJobManager()
    ...
    public static class CancelAll extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            try {
                PrismSpaceCore.getBJobManager().cancelAll(PActivityThread.getAppConfig().processName);
                return method.invoke(who, args);
            } catch (Exception e) {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            try {
                ...
                try {
                    ...
                    Slog.w(TAG, "Enqueue: PrismSpace job manager failed, trying system fallback", e);
                }
