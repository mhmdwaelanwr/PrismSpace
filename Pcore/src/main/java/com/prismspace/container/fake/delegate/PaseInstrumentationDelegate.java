...
public class PaseInstrumentationDelegate extends Instrumentation {
    ...
    public void addResults(Bundle results) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            try {
                ...
                android.util.Log.w("PaseInstrumentationDelegate", "Failed to handle results on older Android version: " + e.getMessage());
            }
        }
    }
    ...
    private void storeResultsForOlderVersions(Bundle results) {
        try {
            ...
            Class<?> resultsStorageClass = Class.forName("com.prismspace.container.utils.ResultsStorage");
            ...
            android.util.Log.d("PaseInstrumentationDelegate", "Stored results with key: " + resultKey);
        } catch (Exception e) {
            android.util.Log.w("PaseInstrumentationDelegate", "Failed to store results in static storage: " + e.getMessage());
        }
    }
    ...
    private void storeResultsInPreferences(Bundle results) {
        try {
            ...
            if (context != null) {
                ...
                editor.apply();
                android.util.Log.d("PaseInstrumentationDelegate", "Stored results in SharedPreferences");
            }
        } catch (Exception e) {
            android.util.Log.w("PaseInstrumentationDelegate", "Failed to store results in preferences: " + e.getMessage());
        }
    }
