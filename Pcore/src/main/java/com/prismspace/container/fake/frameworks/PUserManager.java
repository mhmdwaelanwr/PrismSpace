...
import com.prismspace.container.core.system.user.IBUserManagerService;
import com.prismspace.container.utils.Slog;


public class PUserManager extends PlackManager<IBUserManagerService> {
    private static final String TAG = "PUserManager";
