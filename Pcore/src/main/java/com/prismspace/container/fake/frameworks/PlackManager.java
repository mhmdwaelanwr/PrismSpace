...
public abstract class PlackManager<Service extends IInterface> {
    public static final String TAG = "PlackManager";
    ...
    public Service getService() {
        ...
        try {
            IBinder binder = PrismSpaceCore.get().getService(getServiceName());
            if (binder == null) {
