...
import com.prismspace.container.fake.FakeCore;
...
public class IPackageManagerProxy extends PinderInvocationStub {
    ...
    protected void inject(Object baseInvocation, Object proxyInvocation) {
        ...
        Object systemContext = BRActivityThread.get(PrismSpaceCore.mainThread()).getSystemContext();
    ...
    public static class ResolveIntent extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            ResolveInfo resolveInfo = PrismSpaceCore.getBPackageManager().resolveIntent(intent, resolvedType, flags, PrismSpaceCore.getUserId());
            if (resolveInfo != null) {
                return resolveInfo;
            }
    ...
    public static class ResolveService extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            String resolvedType = (String) args[1];
            int flags = MethodParameterUtils.toInt(args[2]);
            ResolveInfo resolveInfo = PrismSpaceCore.getBPackageManager().resolveService(intent, flags, resolvedType, PrismSpaceCore.getUserId());
            if (resolveInfo != null) {
                return resolveInfo;
            }
            return method.invoke(who, args);
    ...
    public static class GetPackageInfo extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            PackageInfo packageInfo = PrismSpaceCore.getBPackageManager().getPackageInfo(packageName, flags, PrismSpaceCore.getUserId());
            if (packageInfo != null) {
    ...
    public static class GetProviderInfo extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            int flags = MethodParameterUtils.toInt(args[1]);
            ProviderInfo providerInfo = PrismSpaceCore.getBPackageManager().getProviderInfo(componentName, flags, PrismSpaceCore.getUserId());
    ...
    public static class GetReceiverInfo extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ComponentName componentName = (ComponentName) args[0];
            int flags = MethodParameterUtils.toInt(args[1]);
            ActivityInfo receiverInfo = PrismSpaceCore.getBPackageManager().getReceiverInfo(componentName, flags, PrismSpaceCore.getUserId());
    ...
    public static class GetActivityInfo extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ComponentName componentName = (ComponentName) args[0];
            int flags = MethodParameterUtils.toInt(args[1]);
            ActivityInfo activityInfo = PrismSpaceCore.getBPackageManager().getActivityInfo(componentName, flags, PrismSpaceCore.getUserId());
    ...
    public static class GetServiceInfo extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ComponentName componentName = (ComponentName) args[0];
            int flags = MethodParameterUtils.toInt(args[1]);
            ServiceInfo serviceInfo = PrismSpaceCore.getBPackageManager().getServiceInfo(componentName, flags, PrismSpaceCore.getUserId());
            if (serviceInfo != null)
                return serviceInfo;
            if (AppSystemEnv.isOpenPackage(componentName)) {
                return method.invoke(who, args);
    ...
    public static class GetInstalledApplications extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            List<ApplicationInfo> installedApplications = PrismSpaceCore.getBPackageManager().getInstalledApplications(flags, PrismSpaceCore.getUserId());
    ...
    public static class GetInstalledPackages extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            int flags = MethodParameterUtils.toInt(args[0]);
            List<PackageInfo> installedPackages = PrismSpaceCore.getBPackageManager().getInstalledPackages(flags, PrismSpaceCore.getUserId());
    ...
    public static class GetApplicationInfo extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            ApplicationInfo applicationInfo = PrismSpaceCore.getBPackageManager().getApplicationInfo(packageName, flags, PrismSpaceCore.getUserId());
    ...
    public static class QueryContentProviders extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            int flags = MethodParameterUtils.toInt(args[2]);
            List<ProviderInfo> providers = PrismSpaceCore.getBPackageManager().
                    queryContentProviders(PrismSpaceCore.getAppProcessName(), PrismSpaceCore.getBUid(), flags, PrismSpaceCore.getUserId());
    ...
    public static class QueryBroadcastReceivers extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            List<ResolveInfo> resolves = PrismSpaceCore.getBPackageManager().queryBroadcastReceivers(intent, flags, type, PActivityThread.getUserId());
    ...
    public static class ResolveContentProvider extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            int flags = MethodParameterUtils.toInt(args[1]);
            ProviderInfo providerInfo = PrismSpaceCore.getBPackageManager().resolveContentProvider(authority, flags, PActivityThread.getUserId());
            if (providerInfo == null) {
                return method.invoke(who, args);
            }
            return providerInfo;
    ...
    public static class GetPackagesForUid extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            if (uid == PrismSpaceCore.getHostUid()) {
                args[0] = PActivityThread.getBUid();
                uid = (int) args[0];
            }
            String[] packagesForUid = PrismSpaceCore.getBPackageManager().getPackagesForUid(uid);
            Slog.d(TAG, args[0] + " , " + PActivityThread.getAppProcessName() + " GetPackagesForUid: " + Arrays.toString(packagesForUid));
    ...
    public static class getComponentEnabledSetting extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            ApplicationInfo applicationInfo = PrismSpaceCore.getBPackageManager().getApplicationInfo(packageName,0, PActivityThread.getUserId());
    ...
    public static class SetSplashScreenTheme extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            boolean isXiaomi = PuildCompat.isMIUI() || 
