            ...
            Thread.setDefaultUncaughtExceptionHandler(new Thread.UncaughtExceptionHandler() {
                ...
                public void uncaughtException(Thread thread, Throwable throwable) {
                    ...
                    if (isNullContextCrash(throwable)) {
                        ...
                        PrismSpaceCore.get().sendLogs("CRASH DETECTED (Caught/NullContext): " + throwable.getMessage(), true);
                        return; 
                    }
                    ...
                    if (isGooglePlayServicesCrash(throwable)) {
                        ...
                        PrismSpaceCore.get().sendLogs("CRASH DETECTED (Caught/GMS): " + throwable.getMessage(), true);
                        return; 
                    }
                    ...
                    if (isWebViewCrash(throwable)) {
                        ...
                        PrismSpaceCore.get().sendLogs("CRASH DETECTED (Caught/WebView): " + throwable.getMessage(), true);
                        return; 
                    }
                    ...
                    if (isAttributionSourceCrash(throwable)) {
                        ...
                        PrismSpaceCore.get().sendLogs("CRASH DETECTED (Caught/Attribution): " + throwable.getMessage(), true);
                        return; 
                    }
                    ...
                    if (isSocialMediaAppCrash(throwable)) {
                        ...
                        PrismSpaceCore.get().sendLogs("CRASH DETECTED (Caught/SocialMedia): " + throwable.getMessage(), true);
                        return; 
                    }
                    ...
                    try {
                         PrismSpaceCore.get().sendLogs("FATAL CRASH (Uncaught): " + throwable.getMessage(), false);
                    } catch (Throwable e) {
