package com.prismspace.container.utils.provider;
...
import com.prismspace.container.utils.compat.ContentProviderCompat;


public class ProviderCall {
    public static Bundle callSafely(String authority, String methodName, String arg, Bundle bundle) {
        try {
            return call(authority, PrismSpaceCore.getContext(), methodName, arg, bundle, 5);
