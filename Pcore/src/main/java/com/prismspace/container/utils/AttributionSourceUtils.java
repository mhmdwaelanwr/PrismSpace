        ...
        try {
            ...
            for (String fieldName : packageFieldNames) {
                try {
                    ...
                    packageField.set(attributionSource, PrismSpaceCore.getHostPkg());
    ...
    public static Object createSafeAttributionSource() {
        try {
            ...
            try {
                ...
                attributionSource = constructor.newInstance(PrismSpaceCore.getHostUid(), PrismSpaceCore.getHostPkg());
            } catch (Exception e) {
                try {
