...
public class ContextCompat {
    ...
    public static void fixAttributionSourceState(Object obj, int uid) {
        ...
        if (obj != null && BRAttributionSource.get(obj)._check_mAttributionSourceState() != null) {
            ...
            attributionSourceStateContext._set_packageName(PrismSpaceCore.getHostPkg());
    ...
    public static void fix(Context context) {
        try {
            ...
            BRContextImpl.get(context)._set_mBasePackageName(PrismSpaceCore.getHostPkg());
            BRContextImplKitkat.get(context)._set_mOpPackageName(PrismSpaceCore.getHostPkg());
            
            try {
                BRContentResolver.get(context.getContentResolver())._set_mPackageName(PrismSpaceCore.getHostPkg());
            } catch (Exception e) {
            ...
            if (PuildCompat.isS()) {
                try {
                    ...
                    fixAttributionSourceState(BRContextImpl.get(context).getAttributionSource(), PrismSpaceCore.getHostUid());
                } catch (Exception e) {
